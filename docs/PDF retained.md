...
This document describes the exact pattern used in this repo (Premium Care Enrollment) so you can copy it into other repos that should only retain PDFs on confirmed enrollment success.
