...
This document describes the same approach used in **Care+ Enrollment** and **Direct Enrollment** (Sedera HealthShare privacy policy PDF modal on Step 2).
...
>
  ...
  Privacy Policy | Sedera HealthShare
</button>
```
